...
robocopy /mir /z /e /nfl /ndl /njh /njs /nc /ns /np rnd\common ..\..\Dirt_Dark
robocopy /mir /z /e /nfl /ndl /njh /njs /nc /ns /np rnd\common ..\..\Dirt_Win
robocopy /mir /z /e /nfl /ndl /njh /njs /nc /ns /np rnd\common ..\..\Dirt_Light
